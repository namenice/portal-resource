...
class clusterController {
  async create(req, res, next) {
    try {
      const dataCreate = await clusterService.create(req.body);
  ...
  async findAll(req, res, next) {
    try {
      ...
      const dataAll = await clusterService.findAll(search);
  ...
  async findById(req, res, next) {
    try {
      const dataId = await clusterService.findById(req.params.id);
  ...
  async update(req, res, next) {
    try {
      const dataUpdate = await clusterService.update(req.params.id, req.body);
  ...
  async delete(req, res, next) {
    try {
      const result = await clusterService.delete(req.params.id);
