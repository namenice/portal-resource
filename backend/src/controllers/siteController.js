...
const siteController = {
  async create(req, res, next) {
    try {
      const dataCreate = await siteService.create(req.body);
  ...
  async findAll(req, res, next) {
    try {
      ...
      const dataAll = await siteService.findAll(search);
  ...
  async findById(req, res, next) {
    try {
      const dataId = await siteService.findById(req.params.id);
  ...
  async update(req, res, next) {
    try {
      const dataUpdate = await siteService.update(req.params.id, req.body);
  ...
  async delete(req, res, next) {
    try {
      const result = await siteService.delete(req.params.id);
